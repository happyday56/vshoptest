<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" Inherits="Hidistro.UI.Web.Admin.ManageOrder2" %>
                ...
                <ul>
                    <li class="batchHandleButton"><span class="signicon"></span><span class="allSelect">
                        ...
                        <span class="downproduct">
                                <Hi:ImageLinkButton ID="lkbtnExportSubOrder" runat="server" Text="导出订单" /></span>
        ...
        <div class="datalist">
            <asp:DataList ID="dlstOrders" runat="server" DataKeyField="OrderId" Width="100%">
                <HeaderTemplate>
                    <table width="0" border="0" cellspacing="0">
                        <tr class="table_title">
                            ...
                            <td width="14%" class="td_right td_left">商品详情</td>
                ...
                <ItemTemplate>
                    <tr class="td_bg">
                        <td>
                            <input name="CheckBoxGroup" type="checkbox" value='<%#Eval("OrderId") %>' />订单编号：<%#Eval("SubOrderId") %>&nbsp;(<%#Eval("OrderType").ToString() == "1" ? "<span style='color:#000000'>普通订单</span>" : "<span style='color:#ff0000'>开店订单</span>" %>)<asp:Literal ID="group" runat="server" Text='<%#  Eval("GroupBuyId")!=DBNull.Value&& Convert.ToInt32(Eval("GroupBuyId"))>0?"(团)":"" %>' /></td>
                        <td>提交时间：<Hi:FormatedTimeLabel ID="lblStartTimes" Time='<%#Eval("OrderDate") %>' ShopTime="true" runat="server"></Hi:FormatedTimeLabel></td>
                        <td>支付时间：<Hi:FormatedTimeLabel ID="FormatedTimeLabel1" Time='<%#Eval("PayDate") %>' ShopTime="true" runat="server"></Hi:FormatedTimeLabel></td>
                    ...
                    <tr>
                        ...
                        <td><%#Eval("ShipTo") %>&nbsp;</td>
                        <td style="color:#0B5BA5;"><%#Eval("PaymentType") %>&nbsp;</td>
                        <td>
                          <%#Eval("ItemDescription") %> <%-- <Hi:FormatedMoneyLabel ID="lblOrderTotal" Money='<%#Eval("OrderTotal") %>' runat="server" /><span class="Name" style="margin-left: -8px;">&nbsp;<asp:HyperLink ID="lkbtnEditPrice" runat="server" NavigateUrl='<%# "EditOrder.aspx?OrderId="+ Eval("OrderId") %>' Text="修改价格" Visible="false"></asp:HyperLink></span>--%></td>
